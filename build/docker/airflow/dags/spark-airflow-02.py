"""spark-airflow-02.py shows how to use pyspark.

* task01 : downloads data and copies it to a directory on the simulated hadoop fs
* task02 : reads xcom for the data location and loads the data into pyspark
"""
import logging
