...
This project gives you an **Apache Spark** cluster in standalone mode with a **JupyterLab** interface and a simulated **Apache Hadoop Distributed File System**, all built on top of **Docker**.
...
5. Run Apache Spark code using the provided Jupyter [notebooks](build/workspace/) with Scala and PySpark examples.
...
8. Run Apache Spark code using the provided Jupyter [notebooks](build/workspace/) with Scala and PySpark examples.
